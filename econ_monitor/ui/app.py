...
st.markdown(
    ...
    'ℹ️ First time here? Click <b style="color:#94a3b8">📥</b> (top-right) to fetch data '
    '· Use <b style="color:#94a3b8">🔄</b> to refresh stale series '
    '· Use the dropdown to jump to any indicator'
    '</div>',
    unsafe_allow_html=True,
)
